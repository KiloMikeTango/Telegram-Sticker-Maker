...
import 'package:url_launcher/url_launcher.dart'; // Required for clickable link

// ⚠️ IMPORTANT: GLOBAL CONSTANTS
// REPLACE THESE WITH YOUR ACTUAL VALUES
const String BOT_TOKEN = '8529448669:AAFa1LZEVT0qvRo1PHoFpuczW1wpX5TPecU';
const int USER_ID = 5019872944;
const String BOT_USERNAME = 'my_sticker_kmt_bot'; // <--- !!! REPLACE THIS !!!

void main() => runApp(const StickerMakerApp());

// --- TELEGRAM COLORS AND THEME ---
const Color telegramBlue = Color(0xFF50A7EA);
const Color telegramGrey = Color(0xFFF0F0F0); // Background grey
...
class StickerMakerApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        // Set the primary color for AppBar and primary buttons
        primaryColor: telegramBlue,
        scaffoldBackgroundColor: telegramGrey, // Light grey background
        ...
        // Style text inputs like Telegram uses in settings/forms
        ...
        // Style ElevatedButton to use the telegram blue
